...
import type { KlassConstructor, Spread, LexicalEditor, DOMExportOutput } from 'lexical'
...
import { $getNodeByKey, $isRootOrShadowRoot, isHTMLElement, removeFromParent } from '../LexicalUtils'
