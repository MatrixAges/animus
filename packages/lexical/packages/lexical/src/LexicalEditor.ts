...
export type CommandListener<P> = (payload: P, editor: LexicalEditor) => boolean | undefined | void
...
export interface EditorRefs {
	id: string
	text_mode?: boolean
	getNodesFromText: (v: string) => Array<LexicalNode>
	convertFromString?: (text: string) => Array<LexicalNode>
}
...
export function resetEditor(
	...
	pendingEditorState: null | EditorState
): void {
...
export class LexicalEditor {
	...
	/** @internal */
	private resolveRegisteredNodeAfterReplacements(registeredNode: RegisteredNode): RegisteredNode {
	...
	reset() {
		resetEditor(this, this._rootElement, null, null)
	}
}
