import { $getSelection, $isRangeSelection, EditorState, ElementNode, LexicalEditor, TextNode } from 'lexical'
			...
			const differentFocusDOM =
				...
				(currentFocusNode !== previousFocusNode &&
					(!(previousFocusNode instanceof TextNode) ||
						currentFocusNode.updateDOM(previousFocusNode, currentFocusNodeDOM, editor._config)))
