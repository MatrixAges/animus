...
function $patchStyle(
	...
	patch: Record<string, string | null | ((currentStyleValue: string | null, _target: typeof target) => string)>
): void {
...
export function $patchStyleText(
	...
	patch: Record<
		string,
		string | null | ((currentStyleValue: string | null, target: TextNode | RangeSelection) => string)
	>
): void {
