import type { BaseSelection, ElementNode, LexicalNode, NodeKey, Point, RangeSelection, TextNode } from 'lexical'
 ...
 */
export function $setBlocksType(selection: BaseSelection | null, createElement: () => ElementNode): void {
	if (selection === null) {
		return
	}
