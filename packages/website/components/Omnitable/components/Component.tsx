...
import StatusIndicator from '../fields/StatusIndicator'
import Text from '../fields/Text'

import type { IPropsComponent } from '../types'

const Index = (props: IPropsComponent) => {
	const { column, value, editing, onFocus, onBlur } = props
	...
	return <Component {...{ self_props, value, editing, onFocus, onBlur }} />
}
