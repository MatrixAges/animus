export default {
	...
	'🗯️': ['right_anger_bubble', 'caption', 'speech', 'thinking', 'mad', 'angry', 'balloon', 'zag', 'zig'],
	...
	'🖐️': ['hand_with_fingers_splayed', 'hand', 'fingers', 'palm', 'body', 'finger', 'five', 'raised'],
	...
	'☝️': ['index_pointing_up', 'hand', 'fingers', 'direction', 'up', 'body', 'finger', 'point', 'secret', 'white'],
	'👍': [
		'thumbs_up',
		'thumbsup',
		'yes',
	...
	'🙆‍♀️': ['woman_gesturing_ok', 'women', 'girl', 'female', 'pink', 'human', 'woman', 'gesture', 'hand'],
	'💁': [
		'person_tipping_hand',
		'information',
		'attendant',
	...
	'💁‍♂️': ['man_tipping_hand', 'male', 'boy', 'man', 'human', 'information', 'desk', 'help', 'men', 'sassy'],
	'💁‍♀️': ['woman_tipping_hand', 'female', 'girl', 'woman', 'human', 'information', 'desk', 'help', 'sassy', 'women'],
	...
	'🙋‍♀️': ['woman_raising_hand', 'female', 'girl', 'woman', 'gesture', 'happy', 'one', 'raised', 'women'],
	...
	'🤦‍♂️': ['man_facepalming', 'man', 'male', 'boy', 'disbelief', 'exasperation', 'face', 'facepalm', 'men', 'palm'],
	'🤦‍♀️': [
		'woman_facepalming',
		'woman',
		'female',
	...
	'👩‍✈️': ['woman_pilot', 'aviator', 'plane', 'woman', 'human', 'airplane', 'aviation', 'female', 'women'],
	...
	'💂‍♀️': ['woman_guard', 'uk', 'gb', 'british', 'female', 'royal', 'woman', 'guardsman', 'guardswoman', 'women'],
	'👷': [
		'construction_worker',
		'labor',
		'build',
	...
	'🦸‍♂️': ['man_superhero', 'man', 'male', 'good', 'hero', 'superpowers', 'fantasy', 'men', 'superpower'],
	'🦸‍♀️': [
		'woman_superhero',
		'woman',
		'female',
	...
	'🧙‍♀️': ['woman_mage', 'woman', 'female', 'mage', 'witch', 'fantasy', 'sorceress', 'wizard', 'women'],
	...
	'💆‍♀️': ['woman_getting_massage', 'female', 'girl', 'woman', 'head', 'face', 'salon', 'spa', 'women'],
	...
	'💇‍♀️': ['woman_getting_haircut', 'female', 'girl', 'woman', 'barber', 'beauty', 'parlor', 'women'],
	'🚶': ['person_walking', 'move', 'hike', 'pedestrian', 'walk', 'walker'],
	'🚶‍♂️': ['man_walking', 'human', 'feet', 'steps', 'hike', 'male', 'men', 'pedestrian', 'walk'],
	'🚶‍♀️': ['woman_walking', 'human', 'feet', 'steps', 'woman', 'female', 'hike', 'pedestrian', 'walk', 'women'],
	...
	'🧖‍♂️': ['man_in_steamy_room', 'male', 'man', 'spa', 'steamroom', 'sauna', 'hamam', 'men', 'steam', 'steambath'],
	'🧖‍♀️': [
	...
	'🧗‍♂️': ['man_climbing', 'sports', 'hobby', 'man', 'male', 'rock', 'bouldering', 'climber', 'men'],
	'🧗‍♀️': ['woman_climbing', 'sports', 'hobby', 'woman', 'female', 'rock', 'bouldering', 'climber', 'women'],
	...
	'🏌️‍♀️': ['woman_golfing', 'sports', 'business', 'woman', 'female', 'ball', 'golf', 'golfer', 'women'],
	'🏄': ['person_surfing', 'sport', 'sea', 'surf', 'surfer'],
	'🏄‍♂️': ['man_surfing', 'sports', 'ocean', 'sea', 'summer', 'beach', 'male', 'men', 'surfer'],
	'🏄‍♀️': ['woman_surfing', 'sports', 'ocean', 'sea', 'summer', 'beach', 'woman', 'female', 'surfer', 'women'],
	'🚣': ['person_rowing_boat', 'sport', 'move', 'paddles', 'rowboat', 'vehicle'],
	'🚣‍♂️': ['man_rowing_boat', 'sports', 'hobby', 'water', 'ship', 'male', 'men', 'rowboat', 'vehicle'],
	'🚣‍♀️': ['woman_rowing_boat', 'sports', 'hobby', 'water', 'ship', 'woman', 'female', 'rowboat', 'vehicle', 'women'],
	...
	'⛹️‍♀️': ['woman_bouncing_ball', 'sports', 'human', 'woman', 'female', 'basketball', 'player', 'women'],
	'🏋️': [
	...
	'🏋️‍♂️': ['man_lifting_weights', 'sport', 'gym', 'lifter', 'male', 'men', 'weight', 'weightlifter', 'workout'],
	'🏋️‍♀️': [
	...
	'🚴‍♂️': ['man_biking', 'bicycle', 'bike', 'cyclist', 'sports', 'exercise', 'hipster', 'bicyclist', 'male', 'men'],
	'🚴‍♀️': [
		'woman_biking',
		'bicycle',
		'bike',
	...
	'🤹‍♀️': ['woman_juggling', 'juggle', 'balance', 'skill', 'multitask', 'female', 'juggler', 'women'],
	'🧘': ['person_in_lotus_position', 'meditate', 'meditation', 'serenity', 'yoga'],
	'🧘‍♂️': ['man_in_lotus_position', 'man', 'male', 'meditation', 'yoga', 'serenity', 'zen', 'mindfulness', 'men'],
	'🧘‍♀️': [
	...
	'🏗️': ['building_construction', 'wip', 'working', 'progress', 'crane', 'architectural'],
	'🧱': ['brick', 'bricks', 'clay', 'construction', 'mortar', 'wall', 'infrastructure'],
	'🏘️': ['houses', 'buildings', 'photo', 'building', 'group', 'house'],
	'🏚️': ['derelict_house', 'abandon', 'evict', 'broken', 'building', 'abandoned', 'haunted', 'old'],
	'🏠': ['house', 'building', 'home'],
	...
	'⛑️': ['rescue_worker_s_helmet', 'construction', 'build', 'aid', 'cross', 'face', 'hat', 'white', 'worker’s'],
	...
	'🎙️': ['studio_microphone', 'sing', 'recording', 'artist', 'talkshow', 'mic', 'music', 'podcast'],
	...
	'⚖️': ['balance_scale', 'law', 'fairness', 'weight', 'justice', 'libra', 'scales', 'tool', 'zodiac'],
	...
	'↕️': ['up_down_arrow', 'blue-square', 'direction', 'way', 'vertical', 'arrows', 'intercardinal', 'northwest'],
	'↔️': ['left_right_arrow', 'shape', 'direction', 'horizontal', 'sideways', 'arrows', 'horizontal arrows'],
	'↩️': [
	...
	'☸️': ['wheel_of_dharma', 'hinduism', 'buddhism', 'sikhism', 'jainism', 'buddhist', 'helm', 'religion'],
	...
	'✖️': ['multiplication_sign', 'math', 'calculation', 'cancel', 'heavy', 'multiply', 'symbol', 'x'],
	...
	'〰️': ['wavy_dash', 'draw', 'line', 'moustache', 'mustache', 'squiggle', 'scribble', 'punctuation', 'wave'],
	...
	'🏳️‍🌈': ['rainbow_flag', 'flag', 'rainbow', 'pride', 'gay', 'lgbt', 'queer', 'homosexual', 'lesbian', 'bisexual'],
	'🏴‍☠️': ['pirate_flag', 'skull', 'crossbones', 'flag', 'banner', 'jolly', 'plunder', 'roger', 'treasure'],
